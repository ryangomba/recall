...
struct CardListPage: View {
    @StateObject private var cardQuery = CardQuery(store: env.cardStore, params: CardQueryParams(userID: env.sessionStore.user?.id ?? "", needsReview: false, searchText: "", tags: [], notTags: []))
...
struct CardListPage_Previews: PreviewProvider {
